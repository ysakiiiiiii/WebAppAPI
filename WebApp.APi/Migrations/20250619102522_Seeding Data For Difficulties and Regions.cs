    ...
    public partial class SeedingDataForDifficultiesandRegions : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("5bf56a59-309b-4fd7-9ca9-69cb0e3761ce"), "Hard" },
                    { new Guid("a8b68482-1f6c-4dc5-b0fe-46ff0506a6d6"), "Medium" },
                    { new Guid("bc065f8b-411a-4bec-9884-1f49807dead4"), "Easy" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("5bf56a59-309b-4fd7-9ca9-69cb0e3761ce"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("a8b68482-1f6c-4dc5-b0fe-46ff0506a6d6"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("bc065f8b-411a-4bec-9884-1f49807dead4"));
